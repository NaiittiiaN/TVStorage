...
fun WhatsNewDialog(onDismiss: () -> Unit) {
    AlertDialog(
        ...
        title = { Text("Что нового в v1.2.6", fontWeight = FontWeight.Bold) },
        text = {
            LazyColumn(modifier = Modifier.fillMaxWidth()) {
                val updates = listOf(
                    "🔑 Исправлена проблема с обновлением: Теперь подпись приложения всегда одинакова (нужна разовая переустановка)",
